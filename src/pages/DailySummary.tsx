            ...
            <div className="flex flex-col md:flex-row gap-8">
                ...
                <div className="flex-1">
                    <div className="flex items-center justify-between mb-4">
                        ...
                        <button
                            onClick={goToToday}
                            className="bg-gray-800 hover:bg-gray-700 text-gray-300 font-semibold py-1.5 px-4 rounded-lg text-sm"
                        >
                            Today
                        </button>
                    </div>
                ...
                <div className="w-full md:w-72 flex-shrink-0">
                    ...
                    <div className="space-y-3">
                        {weeklySummaries.map((week) => (
                            <div
                                key={week.name}
                                className="p-3 rounded-lg bg-gray-800 border-l-4 border-gray-700"
                            >
