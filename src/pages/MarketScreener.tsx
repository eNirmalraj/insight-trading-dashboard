    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-[60vh] text-center p-6 space-y-6 animate-fade-in">
            ...
            <div className="space-y-2">
                ...
                <h3 className="text-xl font-semibold text-gray-300">Under Construction</h3>
            </div>

            <p className="max-w-md text-gray-400 leading-relaxed">
                We're rebuilding the screener from the ground up to provide more powerful filtering
                and real-time scanning capabilities. Check back soon!
            </p>
