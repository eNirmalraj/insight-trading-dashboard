...
const Subscription: React.FC = () => {
    ...
    const handleCancel = async () => {
        if (
            !confirm(
                'Are you sure you want to cancel your Pro subscription? You will lose access to advanced features.'
            )
        )
            return;
            ...
            <div className="max-w-6xl mx-auto">
                <div className="text-center mb-12">
                    ...
                    <p className="text-gray-400 text-lg max-w-2xl mx-auto">
                        Unlock the full potential of Insight Trading with our Pro plan. Automate
                        strategies, follow experts, and access premium tools.
                    </p>
                </div>
                    ...
                    {plans.map((plan) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="mb-6">
                                    <h3
                                        className={`text-xl font-bold mb-2 ${isPro ? 'text-white' : 'text-gray-300'}`}
                                    >
                                        {plan.name}
                                    </h3>
                                ...
                                <div className="flex-1 space-y-4 mb-8">
                                    {plan.features.map((feature, idx) => (
                                        <div key={idx} className="flex items-start gap-3">
                                            <div
                                                className={`mt-1 p-0.5 rounded-full ${isPro ? 'bg-blue-500/20 text-blue-400' : 'bg-gray-700 text-gray-400'}`}
                                            >
