                    ...
                    <div className="w-32 h-32 rounded-full bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center text-4xl font-bold text-white shadow-lg shrink-0">
                        {profile.avatar_url ? (
                            <img
                                ...
                                title={`${profile.full_name}'s avatar`}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {strategies.length === 0 ? (
                        <p className="text-gray-500 col-span-full">
                            This user hasn't shared any strategies yet.
                        </p>
                    ) : (
                        strategies.map((strategy) => (
                            <div
                                key={strategy.id}
                                className="bg-[#202024] border border-gray-700 rounded-xl overflow-hidden hover:border-blue-500/50 transition-all group"
                            >
                                <div className="p-5">
                                    ...
                                    <div className="flex items-center justify-between text-sm">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <span className="text-gray-500">
                                                PF: {strategy.performance_metrics.profitFactor}
                                            </span>
                                        </div>
