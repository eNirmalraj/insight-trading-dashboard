...
import { WatchlistIcon, AlertIcon, DataWindowIcon, OrderPanelIcon, ObjectTreeIcon, SparklesIcon } from '../IconComponents';
...
interface RightToolbarProps {
    onTogglePanel: (panel: 'watchlist' | 'alerts' | 'dataWindow' | 'orderPanel' | 'objectTree' | 'assistant') => void;
    onOpenAssistant: () => void;
}

const RightToolbar: React.FC<RightToolbarProps> = ({ onTogglePanel, onOpenAssistant }) => {
    const tools = [
        ...
        { icon: <SparklesIcon className="w-5 h-5 text-blue-400" />, name: "Insight AI", action: () => onTogglePanel('assistant') },
    ];
    return (
