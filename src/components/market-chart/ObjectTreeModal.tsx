...
const ObjectTreeModal: React.FC<ObjectTreeModalProps> = ({
    isOpen,
    onClose,
    drawings,
    indicators,
                        ...
                        <>
                            {drawings.length > 0 && (
                                <section className="mb-4">
                                    <h3 className="px-2 text-sm font-semibold text-gray-400 mb-2">
                                    ...
                                    <ul className="space-y-1">
                                        {drawings.map((d) => (
                                            <li
                                                key={d.id}
                                                className="flex items-center justify-between p-2 rounded-md hover:bg-gray-700/50 group"
                                            >
                                                ...
                                                <div className="flex items-center gap-2 opacity-50 group-hover:opacity-100">
                                                    <button
                                                        onClick={() =>
                                                            onToggleDrawingVisibility(d.id)
                                                        }
                                                        title={
                                                            d.isVisible === false ? 'Show' : 'Hide'
                                                        }
                                                    >
                                                        {d.isVisible === false ? (
