...
const ContextMenu: React.FC<ContextMenuProps> = (props) => {
    ...
    return (
        ...
        >
            ...
            />
            {props.drawing && props.onAddDrawingAlert && ['Horizontal Line', 'Horizontal Ray', 'Trend Line', 'Parallel Channel', 'Vertical Line', 'Fibonacci Retracement', 'Gann Box'].includes(props.drawing.type) && (
                <MenuItem
