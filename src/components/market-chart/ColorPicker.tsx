...
export const ColorPicker: React.FC<ColorPickerProps> = ({ color, onChange }) => {
            ...
            <div className="p-3 w-64 bg-[#1E222D] rounded-lg border border-[#2A2E39] shadow-xl">
                <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center gap-2">
                        ...
                        />
                        <span className="bg-[#2A2E39] px-2 py-0.5 rounded textxs text-[#D1D4DC] font-mono text-xs">
                            {hex}
                        </span>
                    </div>
                    <button
    ...
    return (
        <div ref={wrapperRef} className="relative inline-block">
            ...
            >
                <div
                    className="absolute inset-0 z-0 bg-gray-700"
                    style={{
                        backgroundImage:
                        ...
                        {view === 'grid' ? (
                            <div className="bg-[#1E222D] border border-[#2A2E39] rounded-lg p-3 shadow-xl w-64">
                                    ...
                                    {PRESET_COLORS.map((preset) => (
                                        <button
                                            ...
                                            className={`w-6 h-6 rounded border transition-transform ${
                                                ...
                                                (color.startsWith(preset) && opacity === 100)
                                ...
                                <div className="border-t border-[#2A2E39] pt-3 mt-2">
                                    <button
                                        className="w-8 h-8 flex items-center justify-center rounded border border-[#2A2E39] hover:bg-[#2A2E39] transition-colors mb-3"
                                    ...
                                    <div className="space-y-1">
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => {
                                                ...
                                                const rgb = hsvToRgb(hsv);
                                                onChange(
                                                    `rgba(${rgb.r}, ${rgb.g}, ${rgb.b}, ${newOp / 100})`
                                                );
                                            }}
