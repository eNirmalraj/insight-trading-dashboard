...
export const MobileDrawingToolsModal: React.FC<MobileDrawingToolsModalProps> = ({
    ...
    return (
        <div
            className="fixed inset-0 z-[60] bg-black/80 backdrop-blur-sm flex flex-col justify-end animate-slide-in-up"
            onClick={onClose}
        >
            <div
                className="bg-gray-900 rounded-t-2xl p-4 max-h-[70vh] overflow-y-auto border-t border-gray-700"
                        ...
                        <div key={category}>
                            ...
                            <div className="grid grid-cols-4 gap-3">
                                {(categoryTools as typeof tools).map((tool) => (
                                    ...
                                    >
                                        <div className="p-2 rounded-full bg-gray-700 mb-1">
                                            {tool.icon}
                                        </div>
