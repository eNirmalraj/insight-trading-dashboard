    ...
    return (
        <aside className={sidebarClasses}>
            ...
            >
                ...
                <h1
                    className={`text-lg font-bold text-white ml-2 whitespace-nowrap overflow-hidden transition-all duration-300 ${isExpanded ? 'max-w-xs opacity-100' : 'max-w-0 opacity-0'}`}
                >
                    Insight Trading
                </h1>
            </div>
