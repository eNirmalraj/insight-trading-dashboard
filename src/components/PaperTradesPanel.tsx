...
export const PaperTradesPanel: React.FC = () => {
    ...
    if (trades.length === 0) return (
        <div className="p-6 bg-[#0f1115] rounded-xl border border-white/5 text-center">
            <h3 className="text-lg font-medium text-white mb-2">No Paper Trades Yet</h3>
            <p className="text-white/40 text-sm">Enable "Auto Trade" on a script and wait for signals.</p>
        </div>
    );
