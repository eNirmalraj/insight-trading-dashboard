...
const CreatePriceAlertModal: React.FC<CreatePriceAlertModalProps> = ({
    symbol,
    price,
    onClose,
}) => {
        ...
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4">
            ...
            >
                ...
                <div className="p-6 space-y-6">
                    <div className="flex items-center gap-2">
                        ...
                        <select
                            ...
                            className="bg-gray-700/80 border border-gray-600 rounded-md p-2 text-sm text-white focus:outline-none focus:ring-1 focus:ring-blue-500"
                        >
                            {conditions.map((c) => (
                        ...
                        <input
                            ...
                            className="bg-gray-700/80 border border-gray-600 rounded-md p-2 text-sm text-white w-full focus:outline-none focus:ring-1 focus:ring-blue-500"
                        />
                    </div>
                    <div>
                        <label
                ...
                <div className="flex justify-end items-center p-4 bg-gray-900/50 border-t border-gray-700 rounded-b-lg gap-2">
                    <button
                        onClick={onClose}
                        className="px-4 py-2 rounded-md text-sm font-semibold text-gray-300 hover:bg-gray-700/50"
                    >
                        Cancel
                    </button>
                    <button
                        onClick={handleCreate}
                        className="px-5 py-2 rounded-md text-sm font-semibold bg-blue-500 text-white hover:bg-blue-600"
                    >
                        Create
                    </button>
                </div>
